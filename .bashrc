...
# pacman and yay (Fedora aliases kept for compatibility, map to dnf)
alias pacsyu='sudo dnf update'
alias pacsyyu='sudo dnf update'
alias parsua='sudo dnf update'
alias parsyu='sudo dnf update'
alias unlock='sudo rm /var/lib/dnf/history.sqlite.lock'
